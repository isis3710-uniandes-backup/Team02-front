                    ...
                    <div className="card" id="carta">
                            ...
                            <form>
                                ...
                                <div className="container-fluid row">
                                    <div className="col-sm-12">
                                        ...
                                        <input type="submit" value="Create Account" className="btn btn-block login_btn"></input>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div className="card-footer">
                            <div className="d-flex justify-content-center links">
                                Do you have an account? <span className="link" onClick={this.goToLogin}> Sign In</span>
                            </div>
                            <div className="d-flex justify-content-center links">
